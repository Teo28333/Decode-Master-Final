...
public class IntakeConstants {
    ...
    // Power used by the second intake motor while collecting balls.
    public static double secondIntakeSpeed = 0.25;
    ...
    public static double motor2StopThreshold = 50;
    ...
    public static double firstCurrentThreshold = 2250;
    ...
    public static double gateSettleTime = 62.5;
    ...
    public static double openGatePos = 0.4;
    // Servo position for gate closed during intake.
    public static double closeGatePos = 0.0;
}
